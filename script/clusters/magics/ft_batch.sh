...
do
STD_OUTPUT_FILE="/home/guo/RL/dppo/script/clusters/std_output/${IDX}.log"
...
cd /home/guo/RL/dppo/   #$PBS_O_WORKDIR
...
done < /home/guo/RL/dppo/script/clusters/magics/param.info
